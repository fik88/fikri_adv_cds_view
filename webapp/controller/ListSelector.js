sap.ui.define([
		...
		return BaseObject.extend("cds.adv.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias cds.adv.model.ListSelector
			 */
			 ...
			 * @return {cds.adv.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
