							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ZCDFIKRI_ADV3", {
											ebeln : sCurrentId
										});
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "ZCDFIKRI_ADV3 (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'ZCDFIKRI_ADV3 (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all ZCDFIKRI_ADV3 to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "ZCDFIKRI_ADV3 (" + iExpectedLength + ")"}),
									success : function () {
