sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("cds/adv/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("cds.adv.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["cds/adv/localService/mockserver"], function (mockserver) {
